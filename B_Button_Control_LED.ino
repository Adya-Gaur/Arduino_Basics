/*Button is a digital input: HIGH(pressed) or LOW(not pressed). Arduino reads the button state using digitalRead() and controls the LED with digitalWrite() accordingly.
...
Same can be done with multiple buttons too.*/
